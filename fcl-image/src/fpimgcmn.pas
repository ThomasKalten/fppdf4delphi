...
function Swap(This : qword): qword; {$IFNDEF FPC} overload; {$ENDIF}
function Swap(This : int64): int64; {$IFNDEF FPC} overload; {$ENDIF}
function Swap(This : Longword): longword; {$IFNDEF FPC} overload; {$ENDIF}
function Swap(This : integer): integer; {$IFNDEF FPC} overload; {$ENDIF}
function Swap(This : Word): Word; {$IFNDEF FPC} overload; {$ENDIF}
function CalculateCRC (var data; alength:integer) : longword; {$IFNDEF FPC} overload; {$ENDIF}
function CalculateCRC (CRC:longword; var data; alength:integer) : longword; {$IFNDEF FPC} overload; {$ENDIF}
