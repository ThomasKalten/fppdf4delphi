...
{50+04 : Number of imprtant colors used : useful for displaying on VGA256}
   ...
   PColorRGB = ^TColorRGB;
   TColorRGBArray = array [0..(maxInt - 1) div SizeOf(TColorRGB) - 1]  of TColorRGB;
   PColorRGBArray = ^TColorRGBArray;
   ...
   TColorRGBAArray = array [0..(maxInt - 1) div SizeOf(TColorRGBA) - 1]  of TColorRGBA;
